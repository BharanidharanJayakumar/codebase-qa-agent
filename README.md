...
```bash
curl -X POST http://localhost:8080/api/v1/execute/codebase-qa-agent.demo_echo \
...
```bash
curl -X POST http://localhost:8080/api/v1/execute/codebase-qa-agent.demo_analyze_sentiment \
  -H "Content-Type: application/json" \
...
Created by Your Name (you@example.com) on 2026-02-25 09:24:16 UTC
